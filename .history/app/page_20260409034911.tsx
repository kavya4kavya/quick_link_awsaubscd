          ...
          <div className="relative z-10 space-y-4">
            {links.map((link) =>
              link.isCopy ? (
                ...
                >
                  <div className="relative flex h-12 w-12 items-center justify-center overflow-hidden rounded-2xl bg-linear-to-br from-purple-500/30 to-fuchsia-400/20 text-xl border border-white/10">
                    {renderLinkIcon(link)}
                  </div>
